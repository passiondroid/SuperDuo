...
public class ScoresProvider extends ContentProvider
{
    ...
    private static final int MATCHES_WITH_DAYS = 105;
    ...
    private static final String SCORES_BY_DAYS =
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, "days" , MATCHES_WITH_DAYS);
        return matcher;
    }
    ...
    private int match_uri(Uri uri)
    {
        String link = uri.toString();
        {
           ...
           else if(link.contentEquals(DatabaseContract.scores_table.buildScoreBetweenFiveDays().toString()))
           {
               return MATCHES_WITH_DAYS;
           }
